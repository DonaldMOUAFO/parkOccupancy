...
def plot_ds_image(image, rois, occupancy, true_occupancy=None, fname=None, show=False):
    ...
    predicted occupancy.
    Note: rois are expected to be normalized coordinates. True occupancy is a tensor of 0/1 values 
          and represents the occupancy the real occupancy of the slot as observed by a human.
    """
    # plot image
